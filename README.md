...
<body>
  ...
  { "en": "Apa Itu Solder?", "id": "Logam Paduan Untuk Menyambung Komponen." },
  { "en": "Apa Itu Flux?", "id": "Membantu Solder Menempel Dan Membersihkan Permukaan." },
  { "en": "Apa Itu Soldering Iron?", "id": "Alat Pemanas Untuk Melelehkan Solder." },
  { "en": "Apa Itu Desoldering Pump?", "id": "Alat Untuk Menghisap Solder Cair." },
  { "en": "Apa Itu Breadboard?", "id": "Papan Untuk Merangkai Prototipe Tanpa Solder." },
  { "en": "Apa Itu Perfboard?", "id": "Papan Sirkuit Berlubang Untuk Prototipe Permanen." },
  { "en": "Apa Itu PCB (Printed Circuit Board)?", "id": "Papan Dengan Jalur Tembaga Tercetak." },
  { "en": "Apa Itu Jalur (Trace)?", "id": "Garis Tembaga Yang Menghubungkan Komponen." },
  { "en": "Apa Itu Through-Hole Component?", "id": "Komponen Dengan Kaki Yang Menembus Papan." },
  { "en": "Apa Itu Surface-Mount Device (SMD)?", "id": "Komponen Yang Dipasang Di Permukaan Papan." },
  { "en": "Apa Itu Logic Probe?", "id": "Alat Uji Sederhana Untuk Sinyal Digital." },
  { "en": "Apa Itu LCR Meter?", "id": "Mengukur Induktansi, Kapasitansi, Dan Resistansi." },
  { "en": "Apa Itu Tang Potong?", "id": "Untuk Memotong Kaki Komponen Atau Kabel." },
  { "en": "Apa Itu Pengupas Kabel (Wire Stripper)?", "id": "Untuk Melepas Isolasi Kabel." },
  { "en": "Apa Itu Heat Gun?", "id": "Digunakan Untuk Heat Shrink Tubing." },
  { "en": "Apa Itu Heat Shrink Tubing?", "id": "Selongsong Plastik Yang Menyusut Saat Dipanaskan." },
  { "en": "Apa Itu Konektor BNC?", "id": "Konektor Umum Untuk Osiloskop Dan Sinyal RF." },
  { "en": "Apa Itu Konektor SMA?", "id": "Konektor Ulir Kecil Untuk Frekuensi Tinggi." },
  { "en": "Apa Itu Header Pin?", "id": "Konektor Pin Lurus Untuk Papan Sirkuit." },
  { "en": "Apa Itu Jumper Wire?", "id": "Kabel Untuk Menghubungkan Titik Di Breadboard." },
  { "en": "Apa Itu Resistor Film Karbon?", "id": "Jenis Resistor Umum Dan Murah." },
  { "en": "Apa Itu Resistor Film Logam?", "id": "Resistor Dengan Toleransi Dan Stabilitas Lebih Baik." },
  { "en": "Apa Itu Resistor SMD?", "id": "Resistor Berukuran Sangat Kecil Untuk Pemasangan Permukaan." },
  { "en": "Kode Pada Resistor SMD?", "id": "Angka Yang Menunjukkan Nilai Resistansinya." },
  { "en": "Apa Itu Jaringan Resistor?", "id": "Beberapa Resistor Dalam Satu Kemasan." },
  { "en": "Apa Itu Kapasitor Keramik?", "id": "Kapasitor Umum Untuk Frekuensi Tinggi." },
  { "en": "Apa Itu Kapasitor Elektrolit?", "id": "Memiliki Kapasitansi Tinggi, Berpolaritas." },
  { "en": "Apa Itu Kapasitor Tantalum?", "id": "Jenis Kapasitor Elektrolit Dengan Ukuran Kecil." },
  { "en": "Apa Itu Kapasitor Film?", "id": "Kapasitor Stabil Untuk Aplikasi Audio Filter." },
  { "en": "Apa Itu Kapasitor Variabel?", "id": "Kapasitansinya Dapat Diubah, Untuk Tuning Radio." },
  { "en": "Apa Itu Induktor Inti Udara?", "id": "Induktor Tanpa Material Inti." },
  { "en": "Apa Itu Induktor Inti Ferit?", "id": "Menggunakan Inti Ferit Untuk Induktansi Tinggi." },
  { "en": "Apa Itu Choke?", "id": "Induktor Yang Digunakan Untuk Memblokir AC." },
  { "en": "Apa Itu Manik Ferit (Ferrite Bead)?", "id": "Komponen Pasif Untuk Menekan Noise Frekuensi Tinggi." },
  { "en": "Apa Itu Kristal Kuarsa?", "id": "Komponen Untuk Membuat Osilator Yang Sangat Stabil." },
  { "en": "Apa Itu Resonator Keramik?", "id": "Alternatif Lebih Murah Dari Kristal." },
  { "en": "Apa Itu Saklar DIP?", "id": "Dual In-line Package Switch." },
  { "en": "Fungsi Saklar DIP?", "id": "Untuk Mengatur Konfigurasi Pada Papan Sirkuit." },
  { "en": "Apa Itu Tombol Taktil (Tactile Switch)?", "id": "Tombol Tekan Kecil Dengan Umpan Balik Klik." },
  { "en": "Apa Itu Rotary Encoder?", "id": "Kenop Putar Yang Menghasilkan Pulsa Digital." },
  { "en": "Apa Itu Buzzer?", "id": "Menghasilkan Suara Dengung." },
  { "en": "Apa Itu Speaker Piezo?", "id": "Elemen Tipis Yang Menghasilkan Suara." },
  { "en": "Apa Itu Mikrofon Electret?", "id": "Jenis Mikrofon Umum Yang Membutuhkan Daya." },
  { "en": "Apa Itu Thermocouple?", "id": "Sensor Suhu Yang Menghasilkan Tegangan." },
  { "en": "Apa Itu Photoresistor (LDR)?", "id": "Resistansinya Berubah Tergantung Intensitas Cahaya." },
  { "en": "Apa Itu Fototransistor?", "id": "Transistor Yang Dikontrol Oleh Cahaya." },
  { "en": "Apa Itu Sensor Efek Hall?", "id": "Mendeteksi Medan Magnet." },
  { "en": "Aplikasi Sensor Efek Hall?", "id": "Deteksi Posisi, Pengukuran Arus." },
  { "en": "Apa Itu Regulator Tegangan Linier?", "id": "IC Untuk Menstabilkan Tegangan DC." },
  { "en": "Contoh Regulator Linier?", "id": "7805 (Untuk +5V), LM317 (Adjustable)." },
  { "en": "Apa Itu Low-Dropout (LDO) Regulator?", "id": "Regulator Linier Dengan Efisiensi Lebih Baik." },
  { "en": "Apa Itu Switching Regulator?", "id": "Regulator DC-DC Dengan Efisiensi Sangat Tinggi." },
  { "en": "Apa Itu IC Timer 555?", "id": "Sirkuit Terpadu Serbaguna Untuk Pewaktuan." },
  { "en": "Mode Operasi Timer 555?", "id": "Astable, Monostable, Bistable." },
  { "en": "Apa Itu Dioda Signal?", "id": "Dioda Untuk Aplikasi Arus Kecil." },
  { "en": "Contoh Dioda Signal?", "id": "1N4148." },
  { "en": "Apa Itu Dioda Penyearah?", "id": "Dioda Untuk Aplikasi Catu Daya." },
  { "en": "Contoh Dioda Penyearah?", "id": "1N400x Series." },
  { "en": "Apa Itu Transistor Signal?", "id": "Transistor Untuk Aplikasi Penguatan Arus Kecil." },
  { "en": "Contoh Transistor Signal?", "id": "2N3904 (NPN), 2N3906 (PNP)." },
  { "en": "Apa Itu MOSFET Logika-Level?", "id": "Dapat Digerakkan Langsung Oleh Mikrokontroler." },
  { "en": "Apa Itu ESD (Electrostatic Discharge)?", "id": "Pelepasan Listrik Statis Yang Merusak Komponen." },
  { "en": "Bagaimana Mencegah ESD?", "id": "Menggunakan Gelang Antistatis, Alas Kerja ESD." },
  { "en": "Apa Itu EMI (Electromagnetic Interference)?", "id": "Gangguan Yang Dipancarkan Atau Diterima Sirkuit." },
  { "en": "Apa Itu RFI (Radio-Frequency Interference)?", "id": "EMI Dalam Rentang Frekuensi Radio." },
  { "en": "Apa Itu Kompatibilitas Elektromagnetik (EMC)?", "id": "Kemampuan Perangkat Bekerja Tanpa Menyebabkan EMI." },
  { "en": "Apa Itu Kapasitor Bypass/Decoupling?", "id": "Menstabilkan Tegangan Catu Daya Di Dekat IC." },
  { "en": "Di Mana Kapasitor Bypass Dipasang?", "id": "Sedekat Mungkin Dengan Pin Catu Daya IC." },
  { "en": "Apa Itu Ground Plane?", "id": "Lapisan Tembaga Besar Sebagai Jalur Ground." },
  { "en": "Manfaat Ground Plane?", "id": "Mengurangi Noise Dan Memberikan Jalur Kembali." },
  { "en": "Apa Itu Via?", "id": "Lubang Konduktif Yang Menghubungkan Lapisan PCB." },
  { "en": "Apa Itu Solder Mask?", "id": "Lapisan Pelindung Di Atas PCB." },
  { "en": "Apa Itu Silkscreen?", "id": "Label Teks Dan Simbol Di Atas PCB." },
  { "en": "Apa Itu Desain Skematik?", "id": "Proses Menggambar Diagram Rangkaian." },
  { "en": "Apa Itu Desain Tata Letak (Layout)?", "id": "Proses Mendesain Jejak Fisik PCB." },
  { "en": "Apa Itu Perangkat Lunak EDA?", "id": "Electronic Design Automation." },
  ...
  { "en": "Apa Itu Breadboard Power Supply?", "id": "Modul Untuk Memberi Daya Pada Prototipe." },
  { "en": "Apa Itu Kabel Jumper?", "id": "Kabel Fleksibel Untuk Menghubungkan Titik." },
  { "en": "Apa Itu Protoboard?", "id": "Nama Lain Untuk Breadboard." },
  { "en": "Apa Itu Heatsink Compound?", "id": "Pasta Termal Untuk Transfer Panas." },
  { "en": "Apa Itu Standar Keselamatan?", "id": "Peraturan Untuk Memastikan Keamanan Produk Elektronik." },
  { "en": "Contoh Standar Keselamatan?", "id": "UL, CE." },
  { "en": "Apa Itu RoHS?", "id": "Restriction of Hazardous Substances." },
  { "en": "Tujuan RoHS?", "id": "Membatasi Penggunaan Bahan Berbahaya." },
  { "en": "Apa Itu Crowbar Circuit?", "id": "Sirkuit Proteksi Terhadap Tegangan Lebih." },
  { "en": "Apa Itu Polyfuse?", "id": "Sekering Yang Dapat Mereset Sendiri." },
  { "en": "Apa Itu Varistor?", "id": "Melindungi Rangkaian Dari Lonjakan Tegangan." },
  { "en": "Apa Itu Induktor Mode Umum (Common-Mode Choke)?", "id": "Menekan Noise Yang Ada Di Kedua Jalur." },
  { "en": "Apa Itu Dioda Flyback?", "id": "Melindungi Saklar Dari Beban Induktif." },
  { "en": "Apa Itu Rangkaian RC Snubber?", "id": "Melindungi Saklar Dari Efek Switching." },
  { "en": "Apa Itu Osilator Relaksasi?", "id": "Osilator Berbasis Pengisian/Pengosongan Kapasitor." },
  { "en": "Apa Itu Multivibrator?", "id": "Kelas Sirkuit Osilator (Astable, Monostable)." },
  { "en": "Apa Itu 555 Timer?", "id": "IC Populer Untuk Membuat Multivibrator." },
  { "en": "Apa Itu Schmitt Trigger?", "id": "Komparator Dengan Histeresis Untuk Membersihkan Sinyal." }
